 ...
 */
final class Version20260120155603 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album ALTER name TYPE VARCHAR(150)');
        ...
        $this->addSql('ALTER TABLE media ALTER title TYPE VARCHAR(150)');
        ...
        $this->addSql('ALTER TABLE "user" RENAME COLUMN admin TO is_admin');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE album ALTER name TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE media DROP CONSTRAINT fk_6a2ca10ca76ed395');
        $this->addSql('ALTER TABLE media ALTER user_id DROP NOT NULL');
        $this->addSql('ALTER TABLE media ALTER title TYPE VARCHAR(255)');
        ...
        $this->addSql('ALTER TABLE "user" RENAME COLUMN is_admin TO admin');
    }
}
